...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS=' ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/root/toy_ps/SwiftSnails_early/third/openmpi-1.4.5/../local/openmpi --with-mpi=open_mpi --disable-aio"
